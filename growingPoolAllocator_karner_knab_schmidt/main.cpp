...
{	
    ...
    GrowingPoolAllocator allocator(4, 2);

	void* testPtr0 = allocator.alloc(4);
    void* testPtr1 = allocator.alloc(4);
    void* testPtr2 = allocator.alloc(3);
    ...
    *static_cast<int*>(testPtr0) = 5;	
	...
	//void* testPtr2 = allocator.alloc(5);
	...
	//GrowingPoolAllocator allocator2(4, 2);
